  ...
  <div class="relative flex items-center justify-center min-h-screen overflow-hidden bg-[#F0F0F0] font-sans">
    ...
    <div class="w-full max-w-sm p-8 space-y-8 z-10">
      <div class="text-center">
        <h1 class="font-stencil text-6xl md:text-7xl uppercase text-black">
          Log In
        </h1>
...
<style scoped>
.form-input { 
  @apply block w-full px-3 py-2 mt-1 bg-transparent border-b-2 border-black placeholder-gray-400 focus:outline-none focus:border-gray-500 sm:text-sm transition-colors; 
}
.form-button { 
  @apply relative w-full flex justify-center py-3 px-4 border border-transparent text-sm uppercase tracking-wider font-stencil rounded-md text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-300 disabled:opacity-50; 
}
.loading-spinner { 
